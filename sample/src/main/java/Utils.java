...
public class Utils {
    private static final List<String> StopWords = Arrays.asList(
            ...
            "asked", "asking", "asks", "at", "away", "b", "back", "backed", "backing", "backs", "be", "became",
            ...
            "problem", "problems", "put", "puts", "q", "quite", "r", "rather", "really", "right", "right", "room", "rooms", "s",
            "said", "same", "saw", "say", "says", "second", "seconds", "see", "seem", "seemed", "seeming", "seems", "sees",
            "several", "shall", "she", "should", "show", "showed", "showing", "shows", "side", "sides", "since", "small",
            "smaller", "smallest", "so", "some", "somebody", "someone", "something", "somewhere", "state", "states", "still",
            "still", "such", "sure", "t", "take", "taken", "than", "that", "the", "their", "them", "then", "there", "therefore",
            "these", "they", "thing", "things", "think", "thinks", "this", "those", "though", "thought", "thoughts", "three",
            ...
            "wants", "was", "way", "ways", "we", "well", "wells", "went", "were", "what", "when", "where", "whether", "which",
            "while", "who", "whole", "whose", "why", "will", "with", "within", "without", "work", "worked", "working", "works",
            "would", "x", "y", "year", "years", "yet", "you", "young", "younger", "youngest", "your", "yours");

    public static boolean isStopWord(String inputString) {
        return StopWords.contains(inputString);
    }

    private static final MongoClient mongoClient = new MongoClient("localhost", 27017);
    private static final MongoDatabase myMongoDataBase = mongoClient.getDatabase("local");

    public static MongoCollection<Document> mongoAccess(String collectionName) {
        return myMongoDataBase.getCollection(collectionName);
    }
}
